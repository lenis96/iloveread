...
public class LibroAdapter2 extends RecyclerView.Adapter<LibroAdapter2.LibroViewHolder> {
    ...
    public LibroAdapter2(List<Libro> items) {
        this.items = items;
    }
    ...
    public LibroViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.libro_card2, viewGroup, false);
